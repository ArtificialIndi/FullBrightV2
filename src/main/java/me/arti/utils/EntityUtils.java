...
public class EntityUtils
{
    ...
    public synchronized static void faceEntityClient(EntityLivingBase entity)
    {
        ...
        if (rotations != null)
        {
            Minecraft.getMinecraft().thePlayer.rotationYaw = limitAngleChange(Minecraft.getMinecraft().thePlayer.prevRotationYaw, rotations[0], 55);//NoCheat+ bypass!!! //Default value is 55 for max change, i believe this is angles of rotation on any axis. Setting this to 10ish would be much less noticeable. This is the snap angle for when they come back into view i think
    ...
    public static boolean isCorrectEntity(Object o)
    {
        ...
        condition = o instanceof EntityLivingBase || o instanceof EntityAnimal || o instanceof EntityPlayer;
